...
describe("Patient") do
  let(:patient) {Patient.new({:name => "Suzie", :id => nil, :birthday => "2004-04-20"})}
  ...
  describe("#==") do
    it("is the same patient if they have the same name and doctor id") do
      patient1 = Patient.new({:name => "Suzie", :id => nil, :birthday => "2004-04-20"})
      patient2 = Patient.new({:name => "Suzie", :id => nil, :birthday => "2004-04-20"})
